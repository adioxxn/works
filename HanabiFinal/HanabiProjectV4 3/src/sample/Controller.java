...
public class Controller implements Initializable, Obervor {
    ...
    /**
     * This method will update the GUI for each player's hand and the played pile
     */
    ...
    /**
     * This method will be used by the updateUserHands to draw the GUI
     * @param cards
     * @param x
     * @param y
     * @param player
    ...
    /**
     * This method will be used to update the discard pile
     */
    ...
    /**
     * playFieldDiscard will call the discard funciton in the playfield
     * and update the view to the new value of info tokens.
     */
    ...
    /**
     * playFieldPlay will call the play funciton in the playfield
     * and update the view to the new value of player's hand.
     */
    ...
    /**
     * On mouse clicked, open the hint window to give a hint to other player
     * @param actionEvent
     */
