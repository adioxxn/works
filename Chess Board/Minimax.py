# CMPT 317 A Python implementation of Game Tree Search - Minimax
...
#     Minimax search with no bells or whistles
#
...
# To use the Minimax class, you need the following steps
