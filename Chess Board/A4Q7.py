...
class Game(object):
    ...
    def actions(self, state):
        ...
        if (state.maxs_turn):
            ...
            for key in jediMoves:
                allMove.append((key, jediMoves[key][0] - 1, jediMoves[key][1]))
                allMove.append((key, jediMoves[key][0] + 1, jediMoves[key][1]))
                allMove.append((key, jediMoves[key][0], jediMoves[key][1] - 1))
                allMove.append((key, jediMoves[key][0], jediMoves[key][1] + 1))
                allMove.append((key, jediMoves[key][0] - 1, jediMoves[key][1] + 1))
                allMove.append((key, jediMoves[key][0] - 1, jediMoves[key][1] - 1))
                allMove.append((key, jediMoves[key][0] + 1, jediMoves[key][1] + 1))
                allMove.append((key, jediMoves[key][0] + 1, jediMoves[key][1] - 1))
            remove = []
            for i in allMove:
                if (i[1] < 1 or i[1] > state.size):
                    ...
                    remove.append(i)
                for k in jediMoves:
                    if jediMoves.get(k) == i:
                        remove.append(i)
            for i in remove:
                allMove.remove(i)
            allmove= allMove+allmove
            return allmove
        else:
    ...
    def eval(self, state):
        ...
        return len(state.jedis) * 80 + 10 * len(state.rebels) - 80 * len(state.siths)
